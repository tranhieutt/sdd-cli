...
2. **Update README files**: Update both the English version (`README.md`) and the Vietnamese version (`README_vn.md` or similar) of the project's documentation to accurately reflect the latest features or code changes.
